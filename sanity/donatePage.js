export default {
  ...
  fields: [
    ...
    { name: 'formSectionLabel',   title: 'Form section label',      type: 'string', group: 'form', initialValue: 'Make a gift' },
    ...
    { name: 'formIntro',          title: 'Form intro paragraph',    type: 'text', rows: 3, group: 'form', description: 'Optional. Appears above the form.' },
    {
      ...
      rows: 6,
      group: 'form',
      description: 'Paste your full Zeffy embed code here (the <script> or <iframe> tag from Zeffy). It will render on the page automatically.'
    },
  ...
  preview: { prepare() { return { title: 'Donate Page' } } }
}
